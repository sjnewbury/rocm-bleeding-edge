...
src_prepare() {
	...
	sed -e "/find_package(Clang REQUIRED HINTS /s:\${CMAKE_PREFIX_PATH}/llvm PATHS /opt/rocm/llvm:$(get_llvm_prefix ${LLVM_MAX_SLOT}):" -i image/blit_src/CMakeLists.txt || die
