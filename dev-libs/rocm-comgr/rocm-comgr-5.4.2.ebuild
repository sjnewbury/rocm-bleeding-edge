...
PATCHES=(
	...
	"${FILESDIR}/${PN}-5.4.0-c++17.patch"
	#"${FILESDIR}/${PN}-5.4.0-llvm16-r1.patch"
	#"${FILESDIR}/${PN}-5.4.2-backports.patch"
	"${FILESDIR}/amdgpu-internalize-symbols.patch"
	"${FILESDIR}/${PN}-5.4.0-thread-safe.patch"
)
...
src_prepare() {
	...
	sed '/CXX_STANDARD/s/14/17/' -i CMakeLists.txt || die
